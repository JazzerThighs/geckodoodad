## Duplicate address: 0x00000000
- Found in code: 2-Player Adventure Mode [Nick Reynolds]
- Found in code: 6-player match Crash Prevent [wParam]
- Found in code: 99-Stock Online [Krohnos]
- Found in code: Add Smash64 Fastfall Sparkle v1.2 [UnclePunch]
- Found in code: Additional Debug Background Colors [UnclePunch]
- Found in code: Aerial Raptor Boost Popup + Midair Control [UnclePunch]
...
- Found in code: All Players Can Control the Debug Menu (1.02) [wParam]
- Found in code: All Players become Mario (Debug Menu Required to Prevent Freeze) [donny2112]
- Found in code: Always Have Bunny Hood WIP [PKFreeZZy]
...
- Found in code: Big Light Shield Only (L) [Altafen]
- Found in code: Big Light Shield Only (R) [Altafen]
- Found in code: Boot to In Game [UnclePunch]
- Found in code: Bowser - Limit Flame Breath [PKFreeZZy]
- Found in code: Bowser can mash for height during aerial upB [rmn]
- Found in code: Box Glitch Fix [tauKhan]
- Found in code: Brawl Bury Mechanics v1.0.5 [sushie]
- Found in code: Brawl-Style Team Colors [flieskiller]
- Found in code: Brawl-style B Reverse 1.1 [UnclePunch]
- Found in code: Break the Targets Intangibility Glitch Fix [UnclePunch]
- Found in code: Break the Targets Randomizer [Punkline]
- Found in code: Brinstar Depths - No Kraid and Fourside - Weird Rotation [donny2112]
- Found in code: C-Stick Panning while Paused [Achilles]
- Found in code: CPU - Disable Rapid Jabs for C. Falcon [Achilles]
- Found in code: CPU Takeover Minigame [Savestate]
- Found in code: CSS Clone Icons Slide Into Place [UnclePunch]
...
- Found in code: Capped (Tennis) Mode (1.02) [_glook]
- Found in code: Captain Falcon - No Rapid Jabs (CPU only) [Achilles]
- Found in code: Captain Falcon - No Rapid Jabs [Achilles]
- Found in code: Change Rumble Settings from CSS - Color Mod [Sham Rock]
- Found in code: Character Data Struct Custom Flag Init [Achilles]
- Found in code: Charge Smash Attacks with C-Stick [UnclePunch]
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: Clock Shows Current Time [Eon]
- Found in code: Clone (Nana Type) Down-B Freeze Fix [Achilles]
- Found in code: Colored Hitbox IDs [UnclePunch,NeilHarbin0]
- Found in code: Containers Spawn Containers [Punkline]
- Found in code: Costume Dependent Marth Sword Swing Colors (1.02) [Achilles]
- Found in code: Crazy Hand Tag Team Fix [Odante]
- Found in code: Custom Hitbox/Hurtbox Colors [Altafen]
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: D-Pad Down at Vs. Mode CSS Loads Rumble Select Screen [Achilles]
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: DI Draw - Various DI Vert Writing [Achilles]
- Found in code: DUMMY / ICETOP Crash Prevent (Debug Mode)
- Found in code: Dash Grab Overlay [Altafen]
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Deflicker Off By Default [UnclePunch]
- Found in code: Disable "Go!" Text Graphic On Match Start [gadzook]
- Found in code: Disable Bunny Hood Pickup if Lasting Bunny Hood is Active [PKFreeZZy]
...
- Found in code: Display Animation Name For Special Moves In Develop Mode [UnclePunch]
- Found in code: Display Teams Ally v1.1 [UnclePunch]
- Found in code: Display Time at Top Right of CSS 1.1 [UnclePunch]
- Found in code: Display Ungrabbable Hurtboxes [UnclePunch]
- Found in code: Display last RNG call [212 Degrees]
...
- Found in code: Every Sound is now Mr. Saturn [Savestate]
- Found in code: Everyone Can Firefox v1.0 [UnclePunch]
- Found in code: Everyone Can Float v1.1 [UnclePunch]
- Found in code: Extended Name Entry [Dan Salvato]
- Found in code: Extended SH Jump Input Release Window [tauKhan]
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]
- Found in code: Extra characters doesn't crash the game at Victory Screen (1.02) [flieskiller]
- Found in code: Falco Side-B Walljump [UnclePunch]
- Found in code: Falco Up-B Walljump [UnclePunch]
- Found in code: Falco/Fox - Hold Z While *Aerial* Laser Emits to Fire at Half Speed [Achilles]
- Found in code: Falcon Grab Ledge on Side B [UnclePunch]
- Found in code: Falcon Punch Takes 2 Stocks [Todd Bonney]
- Found in code: Falcon Turnaround Up B [UnclePunch]
- Found in code: Fast Fall Overlay [Altafen, Punkline]
- Found in code: Fighters Face Forward
- Found in code: Fighters Stuck in T-Pose
- Found in code: Flash Blue on Missed Smash Turn (v1.02) [Magus]
- Found in code: Flash Color when Fastfall is Available (simple) [Punkline]
- Found in code: Flash Color when Subaction IASA is Available [UnclePunch]
- Found in code: Flash Red on Failed L-Cancel [Achilles1515, Fizzi]
- Found in code: Flush Cache on Scene Change (1.02) [Dan Salvato]
- Found in code: Force 480p 4:3 [UnclePunch]
- Found in code: Force Crash Mid-Match [UnclePunch, DRGN]
- Found in code: Force Nametag for Local Player [Fizzi]
...
- Found in code: Green Overlay during Landing IASA [Altafen]
- Found in code: HUD Transparency v1.1 [UnclePunch]
- Found in code: Hide Character's GFX When Collision Bubbles Enabled [UnclePunch]
...
- Found in code: Hold Start to Force SSS - Deluxe Edition [Achilles]
- Found in code: Hold Start to Skip Results (2 Seconds) [Achilles]
- Found in code: Hold Y for Climber Clone v1.2 [UnclePunch]
...
- Found in code: Ignore Item Drop RNG On Lasting Bunny Hood [PKFreeZZy]
- Found in code: Invisible Firefox [UnclePunch]
- Found in code: Isolated ECB Display [Punkline]
- Found in code: Kirby - Preserve Copy Ability Charge if Hit Out of Non-Copied Specials [PKFreeZZy]
- Found in code: Kirby Can Jump After Up Throw and Forward Throw (1.02) [UnclePunch]
- Found in code: Kirbys Taunt Without Ability Gives Random Ability v1.1 [UnclePunch]
...
- Found in code: Link - Buffed Hylian Shield [UnclePunch, DRGN]
- Found in code: Link Shield Always Active [UnclePunch]
- Found in code: Link's Shield Reflects [UnclePunch]
- Found in code: Link/Y. Link - Boomerang Hookshot Cancel [Achilles]
- Found in code: Load Any Stage over Another SSS Icon in Vs. Mode (1.00) [Achilles]
- Found in code: Load Any Stage over Another SSS Icon in Vs. Mode (1.01) [Achilles]
- Found in code: Load Any Stage over Another SSS Icon in Vs. Mode (1.02) [Achilles]
- Found in code: Load Any Stage over Another SSS Icon in Vs. Mode (PAL) [Achilles]
- Found in code: Longer Moonwalks [UnclePunch]
- Found in code: Low-Poly v2 [UnclePunch,Yakult]
- Found in code: Luigi's Fireball is influenced by his momentum [UnclePunch]
- Found in code: MH/CH Control with Any Port [sushie, Achilles1515]
- Found in code: MH/CH Improvements [sushie]
- Found in code: MH/CH Vibrate on Hit [sushie]
...
- Found in code: Must be On from 1P Stamina Mode to 1P Giga Bowser
- Found in code: Mute City - Invisible Platforms [donny2112]
- Found in code: Mute In-Game Music [Krohnos]
- Found in code: Name Tag Shadow Box Automatically Scales to Tag Length [Achilles]
- Found in code: Nametag = Player's Percent v2.0 [UnclePunch]
- Found in code: Nana Always Throws Debug Option [Achilles]
- Found in code: Nana Respawns After 20 Seconds [UnclePunch]
- Found in code: Nana and Popo Can Share Ledge [UnclePunch]
- Found in code: Nana direction update bug fix (ICs can dd together etc.) (NTSC 1.02) [tauKhan]
- Found in code: Ness - Up-B Once After Hitting A Wall v2 [UnclePunch, PKFreeZZy]
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]
- Found in code: No Default Color Overlays [Altafen]
- Found in code: No Ego Mode [Krohnos]
- Found in code: No Electric SFX [Altafen]
- Found in code: No Smash Charges [Punkline]
- Found in code: No Voice (Local Player Only) [Altafen]
- Found in code: No X / Y [Krohnos]
- Found in code: Obtain Hidden Trophies (Z-button at Lottery Screen) [donny2112/JasonHaffner/cloakedguy]
- Found in code: One Stock Rotations v1.1 [UnclePunch]
...
- Found in code: P1 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
...
- Found in code: P1-P4 All Black [donny2112]
- Found in code: P1-P4 All Gray [donny2112]
- Found in code: P1-P4 Dark Tone [donny2112]
- Found in code: P1-P4 White Tone [donny2112]
- Found in code: P2 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
...
- Found in code: P3 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
...
- Found in code: P4 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
...
- Found in code: PAL Samus - Disable Bomb Jump Grapple Cancel [Achilles]
- Found in code: PAL Samus - Disable Extender [Achilles]
- Found in code: PAL Stock Icons [UnclePunch]
- Found in code: PKT Only Disappears When Hitting Players [UnclePunch]
- Found in code: Partially Invisible Techs v1.1 [Clown, PKFreeZZy]
...
- Found in code: Peach - FSmash Angles Determine FSmash Type [UnclePunch]
- Found in code: Perfect Shield ala Smash Ultimate [UnclePunch]
- Found in code: Permanent Display Number = Nana % damage (1.02) [flieskiller]
- Found in code: Phantom Hit Fix (v1.02) [UnclePunch]
- Found in code: Play MenuForwardSFX on Successful V-Cancel (1.02) [Achilles]
...
- Found in code: Press Z To Strike Characters on CSS
- Found in code: RNG int makes a sound [212 Degrees]
- Found in code: Random Hit Elements, every Non-projectile [Achilles]
- Found in code: Random Stages Set to Illegal Stages Only [Krohnos]
- Found in code: Remove Special Messages [???]
- Found in code: Reverse Aerial Moves [UnclePunch]
- Found in code: ReverseAerialRush (MagicScrumpy)
...
- Found in code: SUPERFOX [SinsOfApathy]
- Found in code: Samus Shoots Random Item [UnclePunch]
- Found in code: Set Menu Music in Sound Test [Dan Salvato]
- Found in code: Sheik/Zelda CPU Disable Transformations [Achilles]
- Found in code: Shiek Up B Edge Cancel [UnclePunch]
...
- Found in code: Skip Memcard Prompt [UnclePunch]
- Found in code: Skip Results Screen, and KO Stars = Games Won [Sham Rock, Achilles]
- Found in code: Smaller "Ready, GO!" Text Graphics on Match Start [UnclePunch]
- Found in code: Smash 4 Yoshi Up B [UnclePunch]
- Found in code: Spawn Lasting Bunny Hood When Resetting Player in Training Mode [PKFreeZZy]
...
- Found in code: Speed Mod/Team Damage (Debug Required, VIBRATION becomes match speed, also toggles team attack) [wParam]
- Found in code: Split Audio Channels 2.0 (v1.02) [UnclePunch]
...
- Found in code: Start Vs. With only 1 Player [UnclePunch]
...
- Found in code: Stock dependent blastzone wrapping (NTSC 1.02) [anonymous]
- Found in code: Stock-Dependant Angel Platform Colors [Achilles1515]
- Found in code: Super Jigglypuff (Special Moves Enhanced)
- Found in code: Super Peach (Special Moves Enhanced) [Jupiter_/donny2112]
...
- Found in code: Tap Jump from Grounded Jump means Death [flieskiller]
- Found in code: Target Test Ends After 9 Targets (1.02) [djwang88]
- Found in code: Taunt Battle (r2) [InternetExplorer]:
- Found in code: Tech Window Display [Altafen]
- Found in code: Throw Hitstun Port Priority Fix v3 [Achilles, PKFreeZZy]
- Found in code: Tilt Stick [Altafen]
- Found in code: Toggle Frozen Stages with Y
- Found in code: Tournament safety codes [Fizzi]
...
- Found in code: Turn Green When Actionable After Throw [Altafen, UnclePunch]
- Found in code: Turn Green When Actionable [UnclePunch]
- Found in code: Turn Green When Pummel is Available [Cappy]
...
- Found in code: UnobscuredHitboxDisplay1.2 (Melee 1.02) [Punkline, Achilles]
- Found in code: Unrestricted Camera in Camera Mode [UnclePunch]
- Found in code: Update TopN Location In ECB Calculation [tauKhan]
- Found in code: Wall Cancelling/Bracing (1.02) [_glook]
- Found in code: Walljump Out of Falcon Side B [UnclePunch]
- Found in code: Walljump Out of Falcon Up B [UnclePunch]
- Found in code: War Gamemode Over Lightning Melee [UnclePunch]
- Found in code: Wavedash Out of JumpSquat ROA-Style [UnclePunch]
...
- Found in code: X + Y Disables Start [Dan Salvato]
...
- Found in code: X+D-Pad Down (P1 Only) Toggles HUD On/Off [Achilles]
- Found in code: X+Y=Short Hop Macro [UnclePunch]
- Found in code: Yoshi - Jump Out of Shield v2 [PKFreeZZy]
- Found in code: Yoshi Aerial Neutral B Grab Gives Jump Back [UnclePunch]
...
- Found in code: All Hits are Windboxes [sushie]
- Found in code: Camera Controls Outside of Pausing (Pause and Unpause When Fight Starts)
- Found in code: Crazy Hand Tag Team Fix [Odante]
- Found in code: Everyone Can Firefox v1.0 [UnclePunch]
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Ganon Float v1.0 [UnclePunch]
- Found in code: Grab Port-Priority Fix - Award Grab to Lower % Player [PKFreeZZy]
- Found in code: Hide Waiting For Game [Nikki, UnclePunch]
- Found in code: Hitbox Extension v1.8.1 [sushie]
- Found in code: Hitboxes Display Knockback Angle v0.3 [rmn, PKFreeZZy]
- Found in code: Ledge Grab Port Priority Fix [Punkline]
- Found in code: Luigi - Always Misfire (1.02) [Achilles]
- Found in code: Optional: Port Priority Fixes [Punkline, Achilles, PKFreeZZy]
- Found in code: P1 1 HP [Jupiter_]
- Found in code: P1 White Tone [donny2112]
- Found in code: P1-P4 White Tone [donny2112]
- Found in code: P2 1 HP [Jupiter_]
- Found in code: P2 Stamina [donny2112]
- Found in code: P2 White Tone [donny2112]
- Found in code: P3 1 HP [Jupiter_]
- Found in code: P3 Stamina [donny2112]
- Found in code: P3 White Tone [donny2112]
- Found in code: P4 1 HP [Jupiter_]
- Found in code: P4 Stamina [donny2112]
- Found in code: P4 White Tone [donny2112]
- Found in code: Port 1 Master Control (L+D-Pad Left - HMN, L+D-Pad Right - CPU) [Jupiter_]
- Found in code: Port 2 Master Control (R+D-Pad Left - HMN, R+D-Pad Right - CPU)[Jupiter_]
- Found in code: Port 3 Master Control (Z+D-Pad Left - HMN, Z+D-Pad Right - CPU)[Jupiter_]
- Found in code: Port 4 Master Control (Y+D-Pad Left - HMN, Y+D-Pad Right - CPU)[Jupiter_]
...
- Found in code: Special Hitbox Angle: 367 v2.1.0 [sushie]
- Found in code: Speed Mod/Team Damage (Debug Required, VIBRATION becomes match speed, also toggles team attack) [wParam]
- Found in code: Stage will Rain Bob-ombs after 20 Seconds [Someguyxg3]
- Found in code: Taunt Battle (r2) [InternetExplorer]:
- Found in code: Toggle Frozen Stages with Y
- Found in code: Tournament safety codes [Fizzi]
- Found in code: Turbo Mode Replaces Single Button Mode v1.3 [UnclePunch]
...
- Found in code: Display last RNG call [212 Degrees]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Enemy Name's Sound Modifier [donny2112]
- Found in code: Every Sound is now Mr. Saturn [Savestate]
- Found in code: Everyone Can Firefox v1.0 [UnclePunch]
- Found in code: Everyone Can Float v1.1 [UnclePunch]
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
...
- Found in code: Ness - Up-B Once After Hitting A Wall v2 [UnclePunch, PKFreeZZy]
- Found in code: No Default Color Overlays [Altafen]
- Found in code: P1 Dark Tone [donny2112]
- Found in code: P1-P4 Dark Tone [donny2112]
- Found in code: P2 Dark Tone [donny2112]
- Found in code: P3 Dark Tone [donny2112]
- Found in code: P4 Dark Tone [donny2112]
- Found in code: Phantom Hit Fix (v1.02) [UnclePunch]
- Found in code: SDI Overlay [Altafen]
- Found in code: SSBM NTSC 1.02-to-PAL Game-play Converter (1.02) [UnclePunch]
- Found in code: Shiek Up B Edge Cancel [UnclePunch]
...
- Found in code: Containers Spawn Containers [Punkline]
- Found in code: Crazy Hand Tag Team Fix [Odante]
- Found in code: Debug Menu - Item Drop Rate Extension [wParam]
...
- Found in code: No Smash Charges [Punkline]
- Found in code: Obtain Hidden Trophies (Z-button at Lottery Screen) [donny2112/JasonHaffner/cloakedguy]
- Found in code: P1 - Enter Battle with 1 Player [donny2112]
- Found in code: P1 All Black [donny2112]
- Found in code: P1-P4 All Black [donny2112]
- Found in code: P2 All Black [donny2112]
- Found in code: P3 All Black [donny2112]
- Found in code: P4 All Black [donny2112]
- Found in code: Play MenuForwardSFX on Successful V-Cancel (1.02) [Achilles]
- Found in code: Polling Drift + Full Visual Buffer Fixes [tauKhan]
- Found in code: Polling Drift Fix - GameCube or Wii [Dan Salvato]
- Found in code: Polling Drift Fix [Dan Salvato]
...
- Found in code: Rumble on Missed L-Cancel v2 [Altafen]
- Found in code: Special Hitbox Angle: 367 v2.1.0 [sushie]
- Found in code: Stamina Mode/Status Modifier (Debug Required, VIBRATION SELECT becomes mode select. DAMAGE SET becomes HP) [wParam]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]
- Found in code: Target Test Ends After 9 Targets (1.02) [djwang88]
- Found in code: Taunt Battle (r2) [InternetExplorer]:
- Found in code: Toggle Frozen Stages with Y
...
- Found in code: MH/CH Improvements [sushie]
- Found in code: Mario and Doc Get Jump Back After Down B [UnclePunch]
- Found in code: Only Victor's Box Shows [donny2112]
- Found in code: P1 All Gray [donny2112]
- Found in code: P1 Low Gravity [donny2112]
- Found in code: P1 Stamina [donny2112]
- Found in code: P1-P4 All Gray [donny2112]
- Found in code: P2 All Gray [donny2112]
- Found in code: P2 Low Gravity [donny2112]
- Found in code: P3 All Gray [donny2112]
- Found in code: P3 Low Gravity [donny2112]
- Found in code: P4 All Gray [donny2112]
- Found in code: P4 Low Gravity [donny2112]
- Found in code: PAL Samus - Disable Extender [Achilles]
- Found in code: Skip Memcard Prompt [UnclePunch]
- Found in code: Skip Results Screen, and KO Stars = Games Won [Sham Rock, Achilles]
- Found in code: Special Hitbox Angle: 367 v2.1.0 [sushie]
- Found in code: Special Move Master Code v3 (fix console crash) [UnclePunch]
- Found in code: Super-Sized Victor [donny2112]
- Found in code: Super-Sized Victor in all Boxes [donny2112]
- Found in code: Toggle Frozen Stages with Y
- Found in code: Tournament safety codes [Fizzi]
- Found in code: Unfreeze Game End (from 20XXTE) [Altafen, Dan Salvato]
- Found in code: Widescreen 16:9 [Dan Salvato, mirrorbender, Achilles1515, UnclePunch]

## Duplicate address: 0x00000005
- Found in code: Additional Debug Background Colors [UnclePunch]
- Found in code: All Characters Have Yoshi Shield Mechanics v2 [UnclePunch]
- Found in code: Boot to In Game [UnclePunch]
- Found in code: Bowser - Limit Flame Breath [PKFreeZZy]
...
- Found in code: Dual 1v1 Mode [Achilles1515, Zauron]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Enable Damage Staling in Develop Mode (1.02) [Achilles]
- Found in code: Extended Name Entry [Dan Salvato]
- Found in code: Falco/Fox - Hold Z While *Aerial* Laser Emits to Fire at Half Speed [Achilles]
- Found in code: Falcon Grab Ledge on Side B [UnclePunch]
- Found in code: Fox and Falco Enter Fall After Side B and Retains Jump (a la Smash 4) v2[UnclePunch]
...
## Duplicate address: 0x00000007
- Found in code: Aerial Raptor Boost Popup + Midair Control [UnclePunch]
- Found in code: Air Grabs v3 [UnclePunch]
- Found in code: Captain Falcon - No Rapid Jabs (CPU only) [Achilles]
- Found in code: Colored Hitbox IDs [UnclePunch,NeilHarbin0]
- Found in code: DamageDown Knockback Condition [UnclePunch]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Falco Up-B Walljump [UnclePunch]
- Found in code: Falcon Punch Takes 2 Stocks [Todd Bonney]
- Found in code: Falcon Turnaround Up B [UnclePunch]
...
- Found in code: Hitbox Extension v1.8.1 [sushie]
- Found in code: Hot Mr. Saturn Potato (1.02) [wParam, Achilles]
- Found in code: Kirby - Land on Platforms During Up Throw Drop [PKFreeZZy]
- Found in code: Kirbys Taunt Without Ability Gives Random Ability v1.1 [UnclePunch]
- Found in code: L-Cancel Training Wheels [Dan Salvato]
- Found in code: Moonwalk With C-Stick ala PM [UnclePunch]
- Found in code: Permanent Display Number = Nana % damage (1.02) [flieskiller]
...
## Duplicate address: 0x00000010
- Found in code: 1,048,576 Vs Matches Played
- Found in code: Big Head Mode [UnclePunch]
- Found in code: Extended SH Jump Input Release Window [tauKhan]
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Hitbox Color Darkens Based On Damage [UnclePunch]
...
## Duplicate address: 0x0000001E
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: Mildly Broken Stage Geometry [Rune]
- Found in code: Stock-Dependant Angel Platform Colors [Achilles1515]

## Duplicate address: 0x0000001F
- Found in code: Change Rumble Settings from CSS - Color Mod [Sham Rock]
- Found in code: DI Draw - Various DI Vert Writing [Achilles]
- Found in code: Disable Bunny Hood Pickup if Lasting Bunny Hood is Active [PKFreeZZy]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
...
## Duplicate address: 0x00000020
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x00000021
- Found in code: Adventure/Event Level Access (LRZ + D-pad)[donny2112]
- Found in code: Hitbox Extension v1.8.1 [sushie]
- Found in code: Port 2 Master Control (R+D-Pad Left - HMN, R+D-Pad Right - CPU)[Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]
...
## Duplicate address: 0x00000022
- Found in code: Adventure/Event Level Access (LRZ + D-pad)[donny2112]
- Found in code: Port 2 Master Control (R+D-Pad Left - HMN, R+D-Pad Right - CPU)[Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]
- Found in code: Target Test Level Access Part 2 (LRZ + D-pad) [donny2112]

## Duplicate address: 0x00000023
- Found in code: Brawl-style B Reverse 1.1 [UnclePunch]
- Found in code: Capped (Tennis) Mode (1.02) [_glook]
- Found in code: MH/CH Improvements [sushie]

## Duplicate address: 0x00000024
- Found in code: Adventure/Event Level Access (LRZ + D-pad)[donny2112]
- Found in code: Nana Respawns After 20 Seconds [UnclePunch]
- Found in code: Single Button Mode - B Only - 2 stocks 5 minutes [Krohnos]
- Found in code: Single Button Mode - B Only [Krohnos]
...
## Duplicate address: 0x00000025
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]

## Duplicate address: 0x00000026
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stealth UCF v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: UCF Slippi v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: Universal Controller Fix v0.8 (NTSC 1.02)

## Duplicate address: 0x00000028
- Found in code: Adventure/Event Level Access (LRZ + D-pad)[donny2112]
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
...
## Duplicate address: 0x0000002B
- Found in code: All Hits are Windboxes [sushie]
- Found in code: Stealth UCF v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: UCF Slippi v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: Universal Controller Fix v0.8 (NTSC 1.02)

## Duplicate address: 0x0000002C
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Hitbox Extension v1.8.1 [sushie]
- Found in code: Special Hitbox Angle: 367 v2.1.0 [sushie]
...
## Duplicate address: 0x00000030
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]
- Found in code: P1 Always Metal [donny2112]
- Found in code: P2 Always Metal [donny2112]
- Found in code: P3 Always Metal [donny2112]
- Found in code: P4 Always Metal [donny2112]

## Duplicate address: 0x00000034
- Found in code: P1 Metal and Low Gravity [donny2112]
- Found in code: P2 Metal and Low Gravity [donny2112]
- Found in code: P3 Metal and Low Gravity [donny2112]
- Found in code: P4 Metal and Low Gravity [donny2112]

## Duplicate address: 0x00000038
- Found in code: Brawl-Style Team Colors [flieskiller]
- Found in code: Disable Wobbling [UnclePunch]

## Duplicate address: 0x0000003E
- Found in code: Ledge Grab Port Priority Fix [Punkline]
- Found in code: Optional: Port Priority Fixes [Punkline, Achilles, PKFreeZZy]

## Duplicate address: 0x0000003F
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Hitboxes Display Knockback Angle v0.3 [rmn, PKFreeZZy]

## Duplicate address: 0x00000040
- Found in code: Dual 1v1 Mode [Achilles1515, Zauron]
- Found in code: Grab Port-Priority Fix - Award Grab to Lower % Player [PKFreeZZy]

## Duplicate address: 0x00000041
- Found in code: Adventure/Event Level Access (LRZ + D-pad)[donny2112]
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Miscellaneous Level Access (LR + D-pad)[donny2112]
- Found in code: Port 1 Master Control (L+D-Pad Left - HMN, L+D-Pad Right - CPU) [Jupiter_]
...
## Duplicate address: 0x00000080
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Name Tag Shadow Box Automatically Scales to Tag Length [Achilles]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x00000085
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: Everyone Can Float v1.1 [UnclePunch]

## Duplicate address: 0x00000098
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x000000FF
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Must Be On - Effects Modifier [donny2112]
- Found in code: SSBM NTSC 1.02-to-PAL Game-play Converter (1.02) [UnclePunch]
- Found in code: Show Player Names [Fizzi, UnclePunch, Enzyme, jmlee337]
- Found in code: Time Switch [Jupiter_]

## Duplicate address: 0x00000140
...
## Duplicate address: 0x00000280
- Found in code: Full Resolution FoD Reflection [UnclePunch]
- Found in code: HQ Fountain of Dreams Reflections [UnclePunch, PKFreeZZy]

## Duplicate address: 0x00000300
...
## Duplicate address: 0x000003E7
- Found in code: P1 999 HP [Jupiter_]
- Found in code: P1 999% Respawn [Jupiter_]
- Found in code: P2 999 HP [Jupiter_]
- Found in code: P2 999% Respawn [Jupiter_]
- Found in code: P3 999 HP [Jupiter_]
- Found in code: P3 999% Respawn [Jupiter_]
- Found in code: P4 999 HP [Jupiter_]
- Found in code: P4 999% Respawn [Jupiter_]

## Duplicate address: 0x00000409
- Found in code: Slot 1 CPU Type/Level Modifier [donny2112]
- Found in code: Slot 2 CPU Type/Level Modifier [donny2112]
- Found in code: Slot 3 CPU Type/Level Modifier [donny2112]
- Found in code: Slot 4 CPU Type/Level Modifier [donny2112]

## Duplicate address: 0x00000801
- Found in code: Button Stage Select (DPad + AY) [Jupiter_]
- Found in code: Port 4 Master Control (Y+D-Pad Left - HMN, Y+D-Pad Right - CPU)[Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]

## Duplicate address: 0x00000802
- Found in code: Button Stage Select (DPad + AY) [Jupiter_]
- Found in code: Port 4 Master Control (Y+D-Pad Left - HMN, Y+D-Pad Right - CPU)[Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]

## Duplicate address: 0x00000804
- Found in code: Button Stage Select (DPad + AY) [Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]

## Duplicate address: 0x00000808
- Found in code: Button Stage Select (DPad + AY) [Jupiter_]
- Found in code: Target Test Level Access Part 1 (LRZY + D-pad) [donny2112]

## Duplicate address: 0x00000C00
- Found in code: P1 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P2 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P3 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P4 Hold Jump while Gaining Height to Gain More [Y.S.]
...
## Duplicate address: 0x00030007
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Random Hit Elements, every Non-projectile [Achilles]

## Duplicate address: 0x00030008
- Found in code: Disable "Go!" Text Graphic On Match Start [gadzook]
- Found in code: Random Hit Elements, every Non-projectile [Achilles]
- Found in code: Samus Shoots Random Item [UnclePunch]

## Duplicate address: 0x00030009
- Found in code: Brawl Bury Mechanics v1.0.5 [sushie]
- Found in code: Display Time at Top Right of CSS 1.1 [UnclePunch]
- Found in code: Samus Shoots Random Item [UnclePunch]

## Duplicate address: 0x0003000A
- Found in code: Brawl Bury Mechanics v1.0.5 [sushie]
- Found in code: CPU Takeover Minigame [Savestate]
- Found in code: Display Time at Top Right of CSS 1.1 [UnclePunch]
- Found in code: Hitbox Extension v1.8.1 [sushie]
...
## Duplicate address: 0x0003000B
- Found in code: Kirbys Taunt Without Ability Gives Random Ability v1.1 [UnclePunch]
- Found in code: Random Hit Elements, every Non-projectile [Achilles]
- Found in code: Show Player Names [Fizzi, UnclePunch, Enzyme, jmlee337]

## Duplicate address: 0x0003000F
- Found in code: Everyone Can Firefox v1.0 [UnclePunch]
- Found in code: Game Over Duration Modifier [Brandondorf9999]
- Found in code: Show Player Names [Fizzi, UnclePunch, Enzyme, jmlee337]

## Duplicate address: 0x00030010
- Found in code: Debug Game-Side Latency (v2) [Fizzi]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x00030016
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stage Striking (Transparent Struck Stages), Method 2 [Dan Salvato]

## Duplicate address: 0x0003001B
- Found in code: Extra characters doesn't crash the game at Victory Screen (1.02) [flieskiller]
- Found in code: SSBM NTSC 1.02-to-PAL Game-play Converter (1.02) [UnclePunch]
- Found in code: Samus Shoots Random Item [UnclePunch]

## Duplicate address: 0x0003001C
- Found in code: Extra characters doesn't crash the game at Victory Screen (1.02) [flieskiller]
- Found in code: Samus Shoots Random Item [UnclePunch]

## Duplicate address: 0x0003001D
- Found in code: Display Time at Top Right of CSS 1.1 [UnclePunch]
- Found in code: Extra characters doesn't crash the game at Victory Screen (1.02) [flieskiller]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
...
## Duplicate address: 0x00030031
- Found in code: Big Light Shield Only (R) [Altafen]
- Found in code: Display Time at Top Right of CSS 1.1 [UnclePunch]

## Duplicate address: 0x000300EC
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x000300FF
- Found in code: Dual 1v1 Mode [Achilles1515, Zauron]
- Found in code: SSBM NTSC 1.02-to-PAL Game-play Converter (1.02) [UnclePunch]

## Duplicate address: 0x00030102
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x0003010F
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x00030208
- Found in code: Dash Grab Overlay [Altafen]
- Found in code: Display Teams Ally v1.1 [UnclePunch]
- Found in code: Force Nametag for Local Player [Fizzi]
- Found in code: Green Overlay during Landing IASA [Altafen]
...
## Duplicate address: 0x00040002
- Found in code: CPU - Disable Rapid Jabs for C. Falcon [Achilles]
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: Polling Drift + Half Visual Buffer Fixes [tauKhan, UnclePunch]
- Found in code: Polling Drift and Half Visual Buffer Fixes - GameCube or Wii [tauKhan, UnclePunch]

## Duplicate address: 0x00040003
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]
- Found in code: Stealth UCF v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: UCF Slippi v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: Universal Controller Fix v0.8 (NTSC 1.02)

## Duplicate address: 0x00040004
- Found in code: CPU Takeover Minigame [Savestate]
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: Disable Rumble When Controller is Unplugged [Dan Salvato]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
...
## Duplicate address: 0x00040006
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x0004000A
- Found in code: Stealth UCF v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: UCF Slippi v0.80 Slippi (1.02) [Dan Salvato, tauKhan, UnclePunch, Fizzi]
- Found in code: Universal Controller Fix v0.8 (NTSC 1.02)

## Duplicate address: 0x0004000C
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x0004000D
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x00040013
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]
- Found in code: Sheik/Zelda CPU Disable Transformations [Achilles]
- Found in code: War Gamemode Over Lightning Melee [UnclePunch]

## Duplicate address: 0x00040018
- Found in code: DI Draw - Various DI Vert Writing [Achilles]
- Found in code: Extra Chars Don't Reset Port If Unavailable [Achilles]

## Duplicate address: 0x00040024
- Found in code: P1-P4 All Black [donny2112]
- Found in code: P1-P4 All Gray [donny2112]
- Found in code: P1-P4 Dark Tone [donny2112]
- Found in code: P1-P4 White Tone [donny2112]

## Duplicate address: 0x00040078
- Found in code: Hold Start to Force SSS - Deluxe Edition [Achilles]
- Found in code: Hold Start to Skip Results (2 Seconds) [Achilles]

## Duplicate address: 0x00050000
- Found in code: Air Grabs v3 [UnclePunch]
- Found in code: Break the Targets Randomizer [Punkline]
- Found in code: CPU Takeover Minigame [Savestate]
- Found in code: Capped (Tennis) Mode (1.02) [_glook]
...
## Duplicate address: 0x00050001
- Found in code: CPU - Disable Rapid Jabs for C. Falcon [Achilles]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: SDI Overlay [Altafen]

## Duplicate address: 0x00050002
- Found in code: Capped (Tennis) Mode (1.02) [_glook]
- Found in code: Extended Name Entry [Dan Salvato]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
...
## Duplicate address: 0x00050003
- Found in code: Tournament safety codes [Fizzi]
- Found in code: X + Y Disables Start [Dan Salvato]

## Duplicate address: 0x00050004
- Found in code: Capped (Tennis) Mode (1.02) [_glook]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]

## Duplicate address: 0x00050006
- Found in code: Disable Wobbling [UnclePunch]
- Found in code: HUD Transparency v1.1 [UnclePunch]

## Duplicate address: 0x00050007
- Found in code: Flash Red on Failed L-Cancel [Achilles1515, Fizzi]
- Found in code: L-Cancel Frame Timer Display v1.0 [UnclePunch]
...
## Duplicate address: 0x00070001
- Found in code: CPU Takeover Minigame [Savestate]
- Found in code: Capped (Tennis) Mode (1.02) [_glook]

## Duplicate address: 0x0007010E
- Found in code: 99-Stock Online [Krohnos]
- Found in code: Mango Axe Wednesday [Krohnos]
- Found in code: No Ego Mode [Krohnos]
- Found in code: No X / Y [Krohnos]
...
## Duplicate address: 0x000A0004
- Found in code: All Players Can Control the Debug Menu (1.02) [wParam]
- Found in code: Hitbox Extension v1.8.1 [sushie]

## Duplicate address: 0x000B0000
- Found in code: Brawl-Style Team Colors [flieskiller]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stage Striking (Transparent Struck Stages), Method 2 [Dan Salvato]
...
## Duplicate address: 0x000B0002
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stage Striking (Transparent Struck Stages), Method 2 [Dan Salvato]

## Duplicate address: 0x000B0020
- Found in code: Always Skip Results Screen, and KO Stars Function Normally [achilles]
- Found in code: Always Skip the Result Screen, and Stock Count = Placement [Sham Rock]
- Found in code: Skip Results Screen, and KO Stars = Games Won [Sham Rock, Achilles]
...
## Duplicate address: 0x000E0014
- Found in code: All Characters Have Yoshi Shield Mechanics v2 [UnclePunch]
- Found in code: Brawl-style B Reverse 1.1 [UnclePunch]
- Found in code: Link Shield Always Active [UnclePunch]

## Duplicate address: 0x000E0028
- Found in code: Turbo Mode Replaces Single Button Mode v1.3 [UnclePunch]
- Found in code: Turn Green when wasting frames (Wait, SquatWait, tumble (= DamageFall), CatchWaitCliffWait) [Kaze]

## Duplicate address: 0x000E00B5
- Found in code: Character Model Turns white during shield stun (v1.02) [InternetExplorer]:
- Found in code: Turn Yellow During Shield Stun [Dan Salvato, standardtoaster, Stratocaster]

## Duplicate address: 0x000E00FF
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]
- Found in code: Stock Control/Crew Battle (1.02) [Jorgasms]
...
## Duplicate address: 0x000F0003
- Found in code: Costume Dependent Marth Sword Swing Colors (1.02) [Achilles]
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]
- Found in code: Stock-Dependant Angel Platform Colors [Achilles1515]

## Duplicate address: 0x000F0004
- Found in code: Costume Dependent Marth Sword Swing Colors (1.02) [Achilles]
- Found in code: Disable Tap Jump [Achilles]
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]

## Duplicate address: 0x000F0005
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]

## Duplicate address: 0x000F002C
- Found in code: Air Grabs v3 [UnclePunch]
- Found in code: Turbo Mode Replaces Single Button Mode v1.3 [UnclePunch]

## Duplicate address: 0x000F00D4
- Found in code: Flash Red on Failed L-Cancel [Achilles1515, Fizzi]
- Found in code: L-Cancel Training Wheels [Dan Salvato]
...
## Duplicate address: 0x00100000
- Found in code: Brawl-Style Team Colors [flieskiller]
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: Dual 1v1 Mode [Achilles1515, Zauron]

## Duplicate address: 0x00100001
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: D-Pad Down at Vs. Mode CSS Loads Rumble Select Screen [Achilles]
- Found in code: Mute City - Invisible Platforms [donny2112]
- Found in code: Tap Jump from Grounded Jump means Death [flieskiller]
- Found in code: Unpredictable Hitboxes and Models (Pausing Causes Freeze) [bopie64]

## Duplicate address: 0x00100004
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: Stock-Dependant Angel Platform Colors [Achilles1515]
...
## Duplicate address: 0x00110003
- Found in code: Online Break the Targets v.02 [Krohnos]
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]
- Found in code: Taunt Battle (r2) [InternetExplorer]:

## Duplicate address: 0x00110004
- Found in code: D-Pad Controls Damage [Dan Salvato]
- Found in code: Z button to toggle NPCs/alternate characters in CSS (1.02) [Achilles1515]

## Duplicate address: 0x0011010E
- Found in code: 99-Stock Online [Krohnos]
- Found in code: Mango Axe Wednesday [Krohnos]
- Found in code: Online Break the Targets v.02 [Krohnos]
- Found in code: Rishi's Jungle Jam [Krohnos]
...
## Duplicate address: 0x00120004
- Found in code: Always Skip the Result Screen, and Stock Count = Placement [Sham Rock]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Skip Results Screen, and KO Stars = Games Won [Sham Rock, Achilles]

## Duplicate address: 0x00120016
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]

## Duplicate address: 0x0012001C
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]

## Duplicate address: 0x0012001D
- Found in code: Stage Striking (Transparent Struck Stages), Method 1 [Sham Rock, Achilles,]
- Found in code: Stage Striking (Whites-out Struck Stages) [Sham Rock]
...
## Duplicate address: 0x00140001
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Hitboxes Display Knockback Angle v0.3 [rmn, PKFreeZZy]
- Found in code: Neutral Spawns for 1v1 and 2v2 (1.02) [Achilles, Jorgasms]

## Duplicate address: 0x00140004
- Found in code: Change Rumble Settings from CSS - Color Mod [Sham Rock]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Peach - Break the Targets Turnip Pull Strategies- Strategy 2 (1.02) [Achilles]
- Found in code: Peach - Break the Targets Turnip Pull Strategies- Strategy 3 (1.02) [Achilles]

## Duplicate address: 0x00140006
- Found in code: Change Rumble Settings from CSS - Color Mod [Sham Rock]
- Found in code: HUD Transparency v1.1 [UnclePunch]
- Found in code: Peach - Break the Targets Turnip Pull Strategies- Strategy 1 (1.02) [Achilles]
- Found in code: Peach - Break the Targets Turnip Pull Strategies- Strategy 2 (1.02) [Achilles]
...
## Duplicate address: 0x00140008
- Found in code: Change Rumble Settings from CSS - Color Mod [Sham Rock]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]

## Duplicate address: 0x00150000
- Found in code: Skip Results Screen, and KO Stars = Games Won [Sham Rock, Achilles]
- Found in code: Z button to toggle NPCs/alternate characters in CSS (1.02) [Achilles1515]

## Duplicate address: 0x00150004
- Found in code: L+R+A+Start Resets Game While Pause Is Off [Sickolas]
- Found in code: LRAStart Resets Game While Pause Is Off [Sickolas]
...
## Duplicate address: 0x00180000
- Found in code: Custom Hitbox/Hurtbox Colors [Altafen]
- Found in code: SUPERFOX [SinsOfApathy]
- Found in code: Swap Z and X for Port 1 on LAN [Altimor]
- Found in code: Swap Z and Y for Port 1 on LAN [Altimor]

## Duplicate address: 0x00180001
- Found in code: Custom Hitbox/Hurtbox Colors [Altafen]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Hitbox Extension v1.8.1 [sushie]
...
## Duplicate address: 0x00190000
- Found in code: Frame Data Visualization Pack v.22 [rmn, UnclePunch, NeilHarbin0]
- Found in code: Reverse Hitbox ID Draw Order [UnclePunch]

## Duplicate address: 0x00190003
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x00190004
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Hitboxes Display Knockback Angle v0.3 [rmn, PKFreeZZy]
...
## Duplicate address: 0x001A0003
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x001A0004
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]
...
## Duplicate address: 0x001C0002
- Found in code: Isolated ECB Display [Punkline]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x001C0004
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Grab Port-Priority Fix - Award Grab to Lower % Player [PKFreeZZy]

## Duplicate address: 0x001C0005
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x001C0006
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: Ledge Grab Limit [UnclePunch]
...
## Duplicate address: 0x001D0000
- Found in code: Break the Targets Randomizer [Punkline]
- Found in code: Everyone Can Float v1.1 [UnclePunch]
- Found in code: Skip Memcard Prompt [UnclePunch]

## Duplicate address: 0x001D0001
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: Stealth tournament codes [Achilles, UnclePunch]

## Duplicate address: 0x001D0004
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
- Found in code: Full friendlies codes [Achilles, UnclePunch]

## Duplicate address: 0x001D0006
- Found in code: Chess Melee Standalone [Achilles1515, UnclePunch]
- Found in code: L-Cancel Frame Timer Display v1.0 [UnclePunch]
- Found in code: Ledge Grab Limit [UnclePunch]
- Found in code: One Stock Rotations v1.1 [UnclePunch]

## Duplicate address: 0x001DFFFF
- Found in code: Polling Drift + Full Visual Buffer Fixes [tauKhan]
- Found in code: Polling Drift and Full Visual Buffer Fixes - Wii Only [tauKhan]

## Duplicate address: 0x001E0000
- Found in code: Announcer Fanfares 2.0 [Punkline]
- Found in code: Full friendlies codes [Achilles, UnclePunch]
- Found in code: Full tournament codes [Achilles, UnclePunch]
- Found in code: HUD Transparency v1.1 [UnclePunch]
...
## Duplicate address: 0x001F0000
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: MH/CH Vibrate on Hit [sushie]
- Found in code: Wavedash Out of JumpSquat ROA-Style [UnclePunch]

## Duplicate address: 0x001F0001
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: Start Vs. With only 1 Player [UnclePunch]

## Duplicate address: 0x001F0002
- Found in code: Start Vs. With only 1 Player [UnclePunch]
- Found in code: Toggle Frozen Stages with Y

## Duplicate address: 0x001F0004
- Found in code: DI Draw - GX Call, v1.1 [Achilles, tauKhan]
- Found in code: Enable 8 Hitbox Support v1.0.0 [sushie]
...
- Found in code: All Battle Visuals Render as Tiny Triangles [Akuryu]
- Found in code: Black Floors with Occasionally Disappearing Models [Akuryu]
- Found in code: Invisible Stage Geometry [Akuryu]
- Found in code: Mildly Broken Stage Geometry [Rune]
...
## Duplicate address: 0x00453A42
- Found in code: P1 Almost All Bonuses [donny2112]
- Found in code: P1 Almost No Bonuses [donny2112]
...
## Duplicate address: 0x004548D2
- Found in code: P2 Almost All Bonuses [donny2112]
- Found in code: P2 Almost No Bonuses [donny2112]
...
## Duplicate address: 0x00455762
- Found in code: P3 Almost All Bonuses [donny2112]
- Found in code: P3 Almost No Bonuses [donny2112]
...
## Duplicate address: 0x004565F2
- Found in code: P4 Almost All Bonuses [donny2112]
- Found in code: P4 Almost No Bonuses [donny2112]

## Duplicate address: 0x0045ACC4
- Found in code: P1 Always Metal [donny2112]
- Found in code: P1 Low Gravity [donny2112]
- Found in code: P1 Metal and Low Gravity [donny2112]
- Found in code: P1 Stamina [donny2112]

## Duplicate address: 0x0045ACE8
- Found in code: P2 Always Metal [donny2112]
- Found in code: P2 Low Gravity [donny2112]
- Found in code: P2 Metal and Low Gravity [donny2112]
- Found in code: P2 Stamina [donny2112]

## Duplicate address: 0x0045AD0C
- Found in code: P3 Always Metal [donny2112]
- Found in code: P3 Low Gravity [donny2112]
- Found in code: P3 Metal and Low Gravity [donny2112]
- Found in code: P3 Stamina [donny2112]

## Duplicate address: 0x0045AD30
- Found in code: P4 Always Metal [donny2112]
- Found in code: P4 Low Gravity [donny2112]
- Found in code: P4 Metal and Low Gravity [donny2112]
- Found in code: P4 Stamina [donny2112]
...
## Duplicate address: 0x00480827
- Found in code: P1 All Black [donny2112]
- Found in code: P1 All Gray [donny2112]
- Found in code: P1 Dark Tone [donny2112]
- Found in code: P1 White Tone [donny2112]

## Duplicate address: 0x0048084B
- Found in code: P2 All Black [donny2112]
- Found in code: P2 All Gray [donny2112]
- Found in code: P2 Dark Tone [donny2112]
- Found in code: P2 White Tone [donny2112]

## Duplicate address: 0x0048086F
- Found in code: P3 All Black [donny2112]
- Found in code: P3 All Gray [donny2112]
- Found in code: P3 Dark Tone [donny2112]
- Found in code: P3 White Tone [donny2112]

## Duplicate address: 0x00480893
- Found in code: P4 All Black [donny2112]
- Found in code: P4 All Gray [donny2112]
- Found in code: P4 Dark Tone [donny2112]
- Found in code: P4 White Tone [donny2112]

## Duplicate address: 0x004D68BC
- Found in code: Debug sound test menu
- Found in code: Master Control Debug Menu (Activates upon Viewing CSS) [donny2112]
...
## Duplicate address: 0x00724000
- Found in code: P1 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P2 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P3 Hold Jump while Gaining Height to Gain More [Y.S.]
- Found in code: P4 Hold Jump while Gaining Height to Gain More [Y.S.]

## Duplicate address: 0x00830000
- Found in code: Isolated ECB Display [Punkline]
- Found in code: Ledge Grab Port Priority Fix [Punkline]
- Found in code: Optional: Port Priority Fixes [Punkline, Achilles, PKFreeZZy]

## Duplicate address: 0x00870000
- Found in code: Ledge Grab Port Priority Fix [Punkline]
- Found in code: Optional: Port Priority Fixes [Punkline, Achilles, PKFreeZZy]
...
## Duplicate address: 0x012A0000
- Found in code: P2 Kirby Body Appearance Modifier [TheLuckyDucky]
- Found in code: P3 Kirby Body Appearance Modifier [TheLuckyDucky]
- Found in code: P4 Kirby Body Appearance Modifier [TheLuckyDucky]

## Duplicate address: 0x012B0000
- Found in code: P1 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
- Found in code: P2 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
- Found in code: P3 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
- Found in code: P4 Ganondorf Carries Sword (Cosmetic Only) [donny2112]
...
## Duplicate address: 0x01AC0000
- Found in code: P1 Almost No Bonuses [donny2112]
- Found in code: P2 Almost No Bonuses [donny2112]
- Found in code: P3 Almost No Bonuses [donny2112]
- Found in code: P4 Almost No Bonuses [donny2112]

## Duplicate address: 0x01AC0001
- Found in code: P1 Almost All Bonuses [donny2112]
- Found in code: P2 Almost All Bonuses [donny2112]
- Found in code: P3 Almost All Bonuses [donny2112]
- Found in code: P4 Almost All Bonuses [donny2112]
